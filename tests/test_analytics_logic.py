...
@patch("routers.analytics._log_store_available", return_value=False)
...
@patch("routers.analytics._log_store_available", return_value=True)
@patch("routers.analytics._log_query")
def test_query_blocked_domains_top(mock_log_query, mock_oo_avail):
    mock_log_query.return_value = [
...
@patch("routers.analytics._log_store_available", return_value=True)
@patch("routers.analytics._log_query")
def test_query_bandwidth_by_domain(mock_log_query, mock_oo_avail):
    mock_log_query.return_value = [
...
@patch("routers.analytics._log_store_available", return_value=True)
@patch("routers.analytics._log_query")
def test_query_requests_by_status(mock_log_query, mock_oo_avail):
    mock_log_query.return_value = [
...
@patch("routers.analytics._log_store_available", return_value=True)
@patch("routers.analytics._log_query")
def test_query_latency_by_domain(mock_log_query, mock_oo_avail):
    mock_log_query.return_value = [
...
@patch("routers.analytics._log_store_available", return_value=True)
@patch("routers.analytics._log_query")
def test_query_credential_usage(mock_log_query, mock_oo_avail):
    mock_log_query.return_value = [
...
@patch("routers.analytics._log_store_available", return_value=True)
@patch("routers.analytics._log_query")
def test_query_blocked_timeseries(mock_log_query, mock_oo_avail):
    mock_log_query.return_value = [
...
@patch("routers.analytics._log_store_available", return_value=True)
@patch("routers.analytics._log_query")
def test_query_request_volume(mock_log_query, mock_oo_avail):
    mock_log_query.return_value = [
...
def test_query_default_params_used():
    ...
    with (
        patch("routers.analytics._log_store_available", return_value=True),
        patch("routers.analytics._log_query", return_value=[]),
    ):
...
def test_diagnose_domain(mock_path, mock_subprocess):
    ...
    with patch("routers.analytics.docker_client") as mock_dc:
        ...
        # Mock log query for recent requests
